...
ignitiondelay800_800 = 2.03;
ignitiondelay800_1200 = 1.61;
ignitiondelay1000_800 = 1.16;
ignitiondelay1000_1200 = 1.08;

ignition_delay = [ignitiondelay800_800 ignitiondelay800_1200 ignitiondelay1000_800 ignitiondelay1000_1200];
%Oxy15 = [1.6 2.256 3.184];
%Oxy10 = [1.87 3 3.616];
%ytotal = [ignition_delay; Oxy15; Oxy10];
...
plot(x,ignition_delay,'square',MarkerFaceColor=[0 0 0],MarkerSize=12,MarkerEdgeColor='none');
hold on

errorbar(x,ignition_delay,errhigh,errlow,"vertical","LineStyle","none",Color=[0 0 0],LineWidth=1);
hold on

x_loc = 1:length(ignition_delay);
y_loc = ignition_delay + 0.05;
text(x_loc+0.1,y_loc,num2str(ignition_delay'),'vert','top','horiz','left','FontSize',20,'Fontname','Times'); 
hold on
...
%coefficients21 = polyfit(x, ignition_delay, 1);

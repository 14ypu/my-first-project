...
%input parameter
temp1200 = [11.12 10.21 6.99];
temp1000 = [12.48 11.76 9.20];
temp800 = [13.07 12.54 8.39];
y = [temp1200; temp1000; temp800];
errhigh = [0.35 0.4 0.45; 0.52 0.4 0.32; 0.4 0.43 0.34];
errlow = [0.35 0.4 0.45; 0.52 0.4 0.32; 0.4 0.43 0.34];
%err = 0.3*y;
%y = [1200K 1000K 800K];
